      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">How Hiringo works</h2>
            <p className="text-xl text-gray-600">With just a few easy and intuitive steps you can create a job offer for the work that needs to be done.</p>
          </div>
