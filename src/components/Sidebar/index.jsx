    ...
    return(
      <div className="lg:w-64">
        ...
        <div
          id="sidebar"
          ref={this.sidebar}
          className={`lg:translate-x-0 transform lg:overflow-y-auto ${style.sidebar_container} ${this.props.isOpen ? 'translate-x-0' : '-translate-x-64'}`}
        >
          ...
          <div className={`${style.sidebar_header}`}>
            ...
            <NavLink exact to="/" className="block">
              <div className="flex">
                <img src={logo} alt="logo" className="filter invert grayscale w-8 h-8 mr-2" />
                <h1 className="logo-font mt-1 filter text-gray-200 text-3xl">{process.env.REACT_APP_NAME}</h1> 
              </div>
            </NavLink>
          </div>
          ...
          <div className="container">
            ...
            <ul className="mt-3">
              ...
              <li className={`${style.link_container}`}>
                <NavLink exact to="/dashboard" className={`${style.link_nav}`}>
              ...
              {/* Service providers */}
              <li className={`${style.link_container}`}>
                <NavLink exact to="/dashboard/service-providers" className={`${style.link_nav}`}>
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    ...
                    <span className={`${style.text}`}>Service providers</span>
                  </div>
                </NavLink>
              </li>
              ...
              {/* Job offers */}
              <li className={`${style.link_container}`}>
                <NavLink exact to="/dashboard/job-offers" className={`${style.link_nav}`}>
                  <div className="flex items-center justify-between">
                    <div className="flex flex-grow">
                      ...
                      <span className={`${style.text}`}>Job offers</span>
                    </div>
                  </div>
                </NavLink>
              </li>
              ...
              {/* Ratings */}
              <li className={`${style.link_container}`}>
                <NavLink exact to="/my-ratings" className={`${style.link_nav}`}>
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    ...
                    <span className={`${style.text}`}>My ratings</span>
                  </div>
                </NavLink>
              </li>
              ...
              {/* Contract list */}
              <li className={`${style.link_container}`}>
                <NavLink exact to="/contracts" className={`${style.link_nav}`}>
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    ...
                    <span className={`${style.text}`}>Contract list</span>
                  </div>
                </NavLink>
              </li>
              ...
              {/* Transactions */}
              <li className={`${style.link_container}`}>
                <NavLink exact to="/dashboard/transactions" className={`${style.link_nav}`}>
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    ...
                    <span className={`${style.text}`}>Transactions</span>
                  </div>
                </NavLink>
              </li>
              ...
              {/* Settings */}
              <li className={`${style.link_container}`}>
                <NavLink exact to="/dashboard/settings" className={`${style.link_nav}`}>
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
