      ...
      >
        ...
        <div className="container">
          ...
          <ul className="mt-3">
            ...
            {/* Orders */}
            <li className={`${style.link_container}`}>
              <NavLink exact to="/dashboard/jobs" className={`${style.link_nav}`}>
                <div className="flex items-center justify-between">
                  <div className="flex flex-grow">
                    ...
                    <span className={`${style.text}`}>Jobs</span>
                  </div>
                </div>
              </NavLink>
            </li>
            ...
            {/* Applications */}
            <li className={`${style.link_container}`}>
              <NavLink exact to="/dashboard/applications" className={`${style.link_nav}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                  ...
                  <span className={`${style.text}`}>Applications</span>
                </div>
              </NavLink>
            </li>
            ...
            {/* Ratings */}
            <li className={`${style.link_container}`}>
              <NavLink exact to="/dashboard/ratings" className={`${style.link_nav}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
            ...
            {/* User Details */}
            <li className={`${style.link_container}`}>
              <NavLink exact to="/dashboard/user-details" className={`${style.link_nav}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
